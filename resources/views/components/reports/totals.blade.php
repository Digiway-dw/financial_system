            ...
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-lg font-semibold text-gray-900">
                        {{ number_format($totals['total_turnover'] ?? 0, 2) }} <span
        ...
        <div class="bg-white rounded-lg p-4 shadow-sm border">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-lg font-semibold text-gray-900">
                        {{ number_format($totals['total_deductions'] ?? 0, 2) }} <span
                            class="text-sm text-gray-500">EGP</span></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg p-4 shadow-sm border">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    @endphp
                    <p class="text-lg font-semibold {{ $profitClass }}">{{ number_format($netProfit, 2) }} <span
                            class="text-sm text-gray-500">EGP</span></p>
                </div>
            </div>
        </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-lg font-semibold text-red-600">
                            {{ number_format($totals['total_expenses'] ?? 0, 2) }} <span
                                class="text-sm text-gray-500">EGP</span></p>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white rounded-lg p-4 shadow-sm border">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-lg font-semibold text-gray-900">
                        {{ number_format($totals['transactions_count'] ?? 0) }}</p>
                </div>
            </div>
        </div>
    </div>
