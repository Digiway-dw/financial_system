            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="flex gap-4 mb-8">
                        <a href="{{ route('transactions.cash') }}" class="px-6 py-3 rounded bg-blue-500 text-white font-bold flex items-center gap-2">
                            <x-heroicon-o-currency-dollar class="w-5 h-5" /> كاش
                        </a>
                        <a href="{{ route('transactions.receive') }}" class="px-6 py-3 rounded bg-green-600 text-white font-bold flex items-center gap-2">
                            <x-heroicon-o-arrow-down-tray class="w-5 h-5" /> استقبال
                        </a>
                        <a href="{{ route('transactions.send') }}" class="px-6 py-3 rounded bg-red-500 text-white font-bold flex items-center gap-2">
