    ...
    <x-slot name="header">
        <div
            ...
            <div class="text-right flex flex-col items-end gap-2">
                ...
                <div id="dashboard-session-timer"
                    class="bg-blue-50 text-blue-600 border border-blue-200 rounded-lg px-4 py-2 shadow-sm font-medium cursor-pointer hover:bg-blue-100 transition-colors duration-200"
