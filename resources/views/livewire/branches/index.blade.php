        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                <div>
                    ...
                    <p class="mt-2 text-sm text-gray-600">Manage your organization branches and their financial operations</p>
                </div>
                ...
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-3xl font-bold text-blue-600">
                            {{ number_format(collect($branches)->sum(function($branch) { return $branch['safe']['current_balance'] ?? 0; }), 2) }} EGP
                        </p>
                    </div>
                </div>
            </div>
                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-150">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    @if(isset($branch['safe']))
                                        <div class="text-sm font-medium text-gray-900">{{ number_format($branch['safe']['current_balance'], 2) }}</div>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">{{ \Carbon\Carbon::parse($branch['created_at'])->format('M d, Y') }}</div>
                                    <div class="text-xs text-gray-500">{{ \Carbon\Carbon::parse($branch['created_at'])->format('H:i') }}</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    @if(isset($branch['safe']))
