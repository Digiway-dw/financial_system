                ...
                @if ($notifications->isEmpty())
                    <div class="px-6 py-12 text-center">
                        ...
                        <p class="text-sm text-gray-500">
                            @if ($tab === 'unread')
                                انت على اطلاع على كل الاشعارات
                            @elseif($tab === 'read')
                                لا يوجد اشعارات مقروءة
                            @else
                                لا يوجد اشعارات
                            @endif
                        </p>
                                    ...
                                    <div class="flex items-start justify-between">
                                        <div class="flex-1">
                                            ...
                                            <h4 class="text-sm font-semibold text-gray-900 mb-1">
                                                {{ $notification->data['title'] ?? 'اشعارات النظام' }}
                                            </h4>

                                            <!-- Notification Message -->
                                            <p class="text-sm text-gray-700 mb-2 leading-relaxed">
                                                {{ $notification->data['message'] ?? 'لديك اشعار جديد' }}
                                            </p>
                                            ...
                                            <div class="flex items-center space-x-4 text-xs text-gray-500">
                                                ...
                                                @if ($notification->read_at)
                                                    <span class="flex items-center text-green-600">
                                                        ...
                                                        مقروء {{ $notification->read_at->diffForHumans() }}
                                                    </span>
                                                @endif
                                            </div>
                                        </div>
