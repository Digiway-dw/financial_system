...
<div>
    <div class="mb-4 text-sm text-gray-600 dark:text-gray-400">
        {{ __('شكرا لك على التسجيل! قبل البدء، هل يمكنك التحقق من عنوان بريدك الإلكتروني عن طريق النقر على الرابط الذي أرسلناه إليك؟ إذا لم تتلق البريد الإلكتروني، سنرسل لك رابط آخر.') }}
    </div>

    @if (session('status') == 'verification-link-sent')
        <div class="mb-4 font-medium text-sm text-green-600 dark:text-green-400">
            {{ __('تم إرسال رابط تحقق جديد إلى عنوان بريدك الإلكتروني الذي قدمته أثناء التسجيل.') }}
        </div>
    @endif
