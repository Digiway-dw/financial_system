        ...
        <form wire:submit.prevent="updateCustomer" class="p-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="space-y-6">
                    <!-- Name -->
                    <div>
                        <label for="name" class="block text-sm font-semibold text-slate-700 mb-2">Customer Name</label>
                    ...
                    <!-- Customer Code -->
                    <div>
                        <label for="customerCode" class="block text-sm font-semibold text-slate-700 mb-2">Customer Code (Optional)</label>
                ...
                <div class="space-y-6">
                    <!-- Balance -->
                    <div>
                        <label for="balance" class="block text-sm font-semibold text-slate-700 mb-2">Balance</label>
                        <div class="relative">
                            <span class="absolute left-4 top-1/2 transform -translate-y-1/2 text-slate-500 font-medium">EGP</span>
                            <input type="number" wire:model="balance" id="balance" name="balance" step="0.01" required
                    ...
                    <div>
                        ...
                        <label for="is_client" class="flex items-center p-4 bg-slate-50/80 border border-slate-200 rounded-xl hover:bg-slate-100/80 cursor-pointer transition-colors duration-150">
                            ...
                            <div class="ml-3">
                                ...
                                <p class="text-xs text-slate-500 mt-1">Mark this customer as a client for special handling</p>
                            </div>
                        </label>
                        @error('is_client')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    ...
                    <!-- Agent ID -->
                    <div>
                        <label for="agent_id" class="block text-sm font-semibold text-slate-700 mb-2">Assigned Agent</label>
