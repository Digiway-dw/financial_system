                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                        <div>
                            ...
                            <p class="text-slate-600 mt-2">Manage your customer base with comprehensive tools and
                                insights</p>
                        </div>
                        @php
                            $canAddCustomer =
            ...
            <div class="mb-8">
                <div class="bg-white/70 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-6 gap-4 items-end">
                        ...
                        <div>
                            <label for="code" class="block text-sm font-medium text-slate-700 mb-2">Customer
                                Code</label>
                        ...
                        <div>
                            <label for="region"
                                class="block text-sm font-medium text-slate-700 mb-2">Region/Area</label>
                            <input type="text" id="region" wire:model.defer="region"
                                class="w-full px-4 py-2.5 bg-white/80 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 transition-all duration-200 text-sm"
                                placeholder="Search by region...">
                        </div>
                        <div>
                            <label for="date_added_start" class="block text-sm font-medium text-slate-700 mb-2">Date
                                Added
                                (Start)</label>
                                ...
                                <tr>
                                    <td colspan="5" class="px-6 py-12 text-center">
                                        <div class="flex flex-col items-center">
                                            ...
                                            <p class="text-sm text-slate-500">Try adjusting your search criteria or add
                                                a new
                                                customer.</p>
                                        </div>
                                    </td>
            ...
            @if ($customerToDelete)
                <div class="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-40">
                    <div class="bg-white rounded-xl shadow-lg p-8 max-w-sm w-full">
                        ...
                        <p class="mb-6">Are you sure you want to delete this customer? This action cannot be undone.
                        </p>
