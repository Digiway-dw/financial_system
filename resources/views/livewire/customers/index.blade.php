    ...
    <div class="mb-8">
        <div class="bg-white/70 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-6 gap-4 items-end">
                ...
                <div>
                    <label for="date_added_start" class="block text-sm font-medium text-slate-700 mb-2">Date Added (Start)</label>
                    <input type="date" id="date_added_start" wire:model.defer="date_added_start" 
                           class="w-full px-4 py-2.5 bg-white/80 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 transition-all duration-200 text-sm">
                </div>
                <div>
                    <label for="date_added_end" class="block text-sm font-medium text-slate-700 mb-2">Date Added (End)</label>
                ...
                <tbody class="divide-y divide-slate-100">
                    @forelse ($customers as $customer)
                        <tr class="hover:bg-slate-50/50 transition-colors duration-150">
                            ...
                            <td class="px-6 py-4">
                                <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium {{ $customer['customer_code'] ? 'bg-slate-100 text-slate-700' : 'bg-gray-100 text-gray-500' }}">
                        ...
                        <tr>
                            <td colspan="5" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center">
                                    ...
                                    <p class="text-sm text-slate-500">Try adjusting your search criteria or add a new customer.</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
