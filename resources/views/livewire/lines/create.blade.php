<div>
    ...
    <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100">Create New Line</h3>

    <form wire:submit.prevent="createLine" class="mt-6 space-y-6">
        <!-- Mobile Number -->
        <div>
        ...
        <div class="flex items-center gap-4">
            <x-primary-button>{{ __('Create Line') }}</x-primary-button>
