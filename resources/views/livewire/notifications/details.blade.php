            ...
            <div class="mb-6">
                ...
                @if (!empty($notification->data['message']))
                    <div class="mb-6">
                        ...
                        <div
                            class="bg-orange-50 border-l-4 border-orange-400 p-4 rounded-xl text-gray-900 whitespace-pre-line font-mono text-sm shadow overflow-x-auto break-words"
                            ...
                            <div class="flex flex-col gap-2 w-full">
                                ...
                                <div class="mt-2 text-xs text-gray-500 italic w-full">
                                    <svg class="w-4 h-4 inline-block mr-1 text-orange-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01" /></svg>
                                    This notification is plain text. Some fields may show as N/A if not available.
                                </div>
                ...
                @if (empty($notification->data['message']))
                    <div class="text-gray-500 italic">No detailed message available.</div>
                @endif
