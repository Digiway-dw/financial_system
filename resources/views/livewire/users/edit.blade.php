            ...
            <form wire:submit.prevent="updateUser" class="p-8">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input id="national_number"
                            class="block w-full px-4 py-3 border border-gray-300 rounded-lg bg-white text-black placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200"
                            type="text" wire:model="national_number" maxlength="14"
                            placeholder="Enter 14-digit national number" />
                ...
                <div class="flex items-center justify-between pt-8 mt-8 border-t border-gray-200">
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <button type="submit"
                            class="inline-flex items-center px-8 py-3 border border-transparent rounded-lg text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200 shadow-sm"
