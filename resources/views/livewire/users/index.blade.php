        ...
        <div class="p-6 bg-white">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-center mt-6">
                <div class="flex items-center mb-4 sm:mb-0">
                    ...
                    <label for="showTrashed" class="ml-2 block text-sm font-medium text-gray-700">Show Deleted
                        Users</label>
                </div>

                <button wire:click="resetFilters" type="button"
                    class="inline-flex items-center px-4 py-2 bg-gray-200 border border-transparent rounded-md font-medium text-xs text-gray-700 uppercase tracking-widest hover:bg-gray-300 active:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition">
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        <th scope="col"
                            class="px-8 py-3.5 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">
                            User
                        </th>
                        <th scope="col"
                            class="px-8 py-3.5 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">
                            ...
                            <td class="px-8 py-5 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 h-10 w-10">
                                        ...
                                        @endphp
                                        <div
                                            class="{{ $randomColor }} rounded-full flex items-center justify-center h-10 w-10 text-white font-bold shadow-md">
                                            {{ substr($initials, 0, 2) }}
                                        </div>
                                    </div>
                                    <div class="ml-4">
                            ...
                            <td class="px-8 py-5 whitespace-nowrap">
                                ...
                                @else
                                    @php
                                        ...
                                        $roleColor =
                                            $roleColors[strtolower($roleName)] ?? 'bg-slate-600 hover:bg-slate-700';
                                    @endphp
                                    <span
                                        class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full {{ $roleColor }} text-white shadow-sm transition-all duration-200">
                                        {{ $roleName }}
                                    </span>
                                @endif
                            </td>
            ...
            <div x-show="show" x-transition:enter="ease-out duration-300"
                ...
                <div class="mt-5 sm:mt-6 sm:flex sm:flex-row-reverse">
                    <button wire:click="deleteUser" type="button"
                        class="inline-flex items-center justify-center px-4 py-2 ml-3 bg-red-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-red-700 focus:bg-red-700 active:bg-red-800 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 transition ease-in-out duration-150"
            ...
            <div x-show="show" x-transition:enter="ease-out duration-300"
                ...
                <div class="mt-5 sm:mt-6 sm:flex sm:flex-row-reverse">
                    <button wire:click="restoreUser" type="button"
                        class="inline-flex items-center justify-center px-4 py-2 ml-3 bg-green-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition ease-in-out duration-150"
                        wire:loading.attr="disabled">
                        Restore
                    </button>
