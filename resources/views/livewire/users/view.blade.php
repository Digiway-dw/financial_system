        ...
        <div class="p-6">
            <div class="flex flex-col sm:flex-row">
                ...
                <div class="flex flex-col items-center mb-6 sm:mb-0 sm:mr-8">
                    <div class="relative">
                        <div class="h-32 w-32 bg-indigo-100 rounded-full flex items-center justify-center text-2xl font-bold text-indigo-600 mb-3">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse ($transactions as $transaction)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{{ $transaction->type ?? '-' }}</td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{{ $transaction->created_at ? $transaction->created_at->format('Y-m-d H:i') : '-' }}</td>
                            </tr>
                        @empty
                            <tr>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Session Duration</th>
                        </tr>
                    </thead>
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        @empty
                            <tr>
                                <td colspan="3" class="px-6 py-4 text-center text-sm text-gray-500">No login history found.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
