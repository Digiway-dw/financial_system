<div class="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-teal-50">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-200/50 p-8">
            <form wire:submit.prevent="updateSafe" class="space-y-8">
                ...
                <div class="space-y-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input wire:model="branchName" id="branchName" name="branchName" type="text" readonly
                                class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-xl bg-gray-50 text-gray-600 cursor-not-allowed" />
                        </div>
