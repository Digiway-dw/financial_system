<div class="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-red-50" dir="rtl"
    style="direction: rtl; text-align: right;" wire:poll.10s>
    <style>
                ...
                <div class="flex items-center justify-between w-full">
                    ...
                    <div class="flex items-center gap-3">
                        <a href="{{ route('transactions.history') }}" 
                           class="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-lg hover:from-indigo-600 hover:to-purple-700 transition-all duration-200 shadow-lg">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                            </svg>
                            تاريخ المعاملات
                        </a>
                        <button wire:click="$refresh" class="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-lg hover:from-blue-600 hover:to-blue-700 transition-all duration-200 shadow-lg">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
