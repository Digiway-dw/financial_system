    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mt-8 overflow-x-auto">
            <div class="bg-white rounded-2xl shadow-lg p-0 md:p-0 transition-all duration-300"
                ...
                <table class="min-w-full divide-y divide-blue-100 text-xs rtl text-right border border-blue-200"
                    style="font-size: 12px;">
                    <thead>
                        <tr>
                            <!-- Reference Number (Most Important for Identification) -->
                            <th class="px-2 py-2 bg-blue-50 text-center text-xs font-bold text-blue-900 tracking-wider min-w-[100px] sortable-header border-b border-blue-200 border-l border-blue-200 rounded-tr-2xl"
                            ...
                            <!-- Transaction Type -->
                            <th class="px-2 py-2 bg-blue-50 text-center text-xs font-bold text-blue-900 tracking-wider min-w-[80px] sortable-header border-b border-blue-200 border-l border-blue-200"
                            ...
                            <!-- Customer Name -->
                            <th class="px-2 py-2 bg-blue-50 text-center text-xs font-bold text-blue-900 tracking-wider min-w-[100px] sortable-header border-b border-blue-200 border-l border-blue-200"
                            ...
                            <!-- Commission -->
                            <th class="px-2 py-2 bg-blue-50 text-center text-xs font-bold text-blue-900 tracking-wider min-w-[70px] sortable-header border-b border-blue-200 border-l border-blue-200"
                            ...
                            <!-- Recipient Mobile -->
                            <th
                                class="px-2 py-2 bg-blue-50 text-center text-xs font-bold text-blue-900 tracking-wider min-w-[100px] border-b border-blue-200 border-l border-blue-200">
                            ...
                            <!-- Actions -->
                            <th
                                class="px-2 py-2 bg-blue-50 text-center text-xs font-bold text-blue-900 tracking-wider min-w-[120px] border-b border-blue-200 border-l border-blue-200 rounded-tl-2xl whitespace-nowrap">
                                إجراءات
                            </th>
                        </tr>
                    </thead>
                    <tbody class="bg-white divide-y divide-blue-50 text-xs" style="font-size: 12px;">
                        @forelse ($transactions as $transaction)
                            <tr
                                ...
                                <!-- Reference Number -->
                                <td
                                    class="px-2 py-2 whitespace-nowrap text-center text-gray-700 font-bold border-l border-blue-200">
                                ...
                                <!-- Amount -->
                                <td
                                    class="px-2 py-2 whitespace-nowrap text-center text-green-700 font-bold border-l border-blue-200">
                                    {{ format_int($transaction['amount']) }} ج.م</td>
                                <!-- Commission -->
                                <td
                                    class="px-2 py-2 whitespace-nowrap text-center text-purple-700 font-bold border-l border-blue-200">
