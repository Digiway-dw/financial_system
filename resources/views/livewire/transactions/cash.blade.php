            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        @if($canDeposit)
                        <div class="bg-gradient-to-r from-blue-50 to-blue-100 p-6 rounded-lg shadow-md border border-blue-200">
                            ...
                            <p class="text-blue-600 mb-4">Add funds to a safe, client wallet, or for administrative purposes.</p>
                            <a href="{{ route('transactions.cash.deposit') }}" class="inline-block bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 transition duration-200">
                                Proceed to Deposit
                            </a>
                        </div>
                        @endif
                        ...
                        @if($canWithdraw)
                        <div class="bg-gradient-to-r from-red-50 to-red-100 p-6 rounded-lg shadow-md border border-red-200">
                            <div class="flex items-center justify-between mb-4">
                            ...
                            <p class="text-red-600 mb-4">Withdraw funds from a safe, client wallet, or for administrative purposes.</p>
                            <a href="{{ route('transactions.cash.withdrawal') }}" class="inline-block bg-red-600 text-white px-4 py-2 rounded-md hover:bg-red-700 transition duration-200">
