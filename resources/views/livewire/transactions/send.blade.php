<div class="max-w-3xl mx-auto bg-white rounded-lg shadow-lg p-6 mt-8">
    <h2 class="text-2xl font-bold mb-4">Send Transfer</h2>
    <form>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="flex items-center mt-4">
                <input id="collect_wallet" type="checkbox" class="mr-2" />
                <label for="collect_wallet">Collect from Client Wallet (Send only)</label>
            </div>
            <div>
