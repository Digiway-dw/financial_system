<div>
    <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100">Edit Transaction</h3>

    <form wire:submit.prevent="updateTransaction" class="mt-6 space-y-6">
        <!-- Customer Name -->
        <div>
        ...
        <div>
            <x-input-label for="agentName" :value="__('Agent Name')" />
            <x-text-input wire:model="agentName" id="agentName" name="agentName" type="text" class="mt-1 block w-full" readonly />
        ...
        <!-- Line -->
        <div>
            <x-input-label for="lineId" :value="__('Line Used')" />
        ...
        <!-- Safe -->
        <div>
            <x-input-label for="safeId" :value="__('Safe Used')" />
